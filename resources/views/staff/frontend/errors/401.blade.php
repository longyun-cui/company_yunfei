...
@section('head_title','403 没有权限 - 云飞钢琴')
    ...
    <div class="col-sm-12 col-md-12 container-body-left" style="width:100%;float:left;text-align:center;">
        ...
        <div class="error-page">
            ...
            <div class="error-content">
                ...
                <h3 class="_none"><i class="fa fa-warning text-yellow"></i> Oops! Page Unauthorized.</h3>
                ...
                <h4 style="margin-top:32px;font-size:20px;font-weight:300;">
                    ...
                    {{--抱歉--}}
                    <b>{{ $error["text"] or '您访问的该页面未被授权！' }}</b>
                </h4>
                <p>
{{--                    {{ $error["text"] or '您访问的该页面未被授权！' }}--}}
                </p>
                ...
                <div>
                    <span id="time" data-time="5" style="color:#ff0018;">5</span> 秒钟自动跳到首页
                </div>
