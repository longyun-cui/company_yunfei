...
@section('head_title','全部用户 - 云飞钢琴')


@section('header','')
@section('description','全部用户 - 管理员后台 - 云飞钢琴')
@section('breadcrumb')
...
//                        d.updated_at_to = $('input[name="updated_at_to"]').val();
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        render: function(data, type, row, meta) {
                            if(data == 0) return '管理员';
                            else if(data == 11) return '<small class="btn-xs bg-primary">总经理</small>';
                            else if(data == 19) return '<small class="btn-xs bg-olive">经理</small>';
                            else if(data == 41) return '<small class="btn-xs bg-purple">员工</small>';
                            else if(data == 51)
                            {
                                ...
                                else if(row.user_type == 19) return '<small class="btn-xs bg-purple">经理</small>';
                                else if(row.user_type == 41) return '<small class="btn-xs bg-purple">员工</small>';
...
@include(env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-script')
@endsection
