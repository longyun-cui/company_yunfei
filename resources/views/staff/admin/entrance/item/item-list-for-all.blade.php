                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            else if(data == 1) $item_type_html = '<small class="btn-xs bg-olive">售前</small>';
                            else if(data == 2) $item_type_html = '<small class="btn-xs bg-primary">回收</small>';
                            else if(data == 3) $item_type_html = '<small class="btn-xs bg-orange">调琴</small>';
...
//                            else
//                            {
//                                return '<a target="_blank" href="/item/'+row.custom.model+'">'+data+'</a>';
//                            }
                            return '<a target="_blank" href="/item/'+row.custom.model+'">'+row.custom.model+'</a>';
                        }
                    },
                    {
                        "className": "text-left",
...
//                                else return "--";
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if(row.is_show == 1)
                            {
                                $html_show = '<a class="btn btn-xs btn-danger item-admin-hide-submit" data-id="'+data+'">隐藏</a>';
                            }
                            else
                            {
                                $html_show = '<a class="btn btn-xs btn-success item-admin-show-submit" data-id="'+data+'">显示</a>';
                            }
...
@include(env('TEMPLATE_STAFF_ADMIN').'entrance.item.item-script')
@endsection
