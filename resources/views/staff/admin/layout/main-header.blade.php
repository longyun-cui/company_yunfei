            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @if(!empty(Auth::guard('staff_admin')->user()->portrait_img))
                            <img src="{{ url(env('DOMAIN_CDN').'/'.Auth::guard('staff_admin')->user()->portrait_img) }}" class="user-image" alt="User">
                        @else
                            <img src="/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                        @endif
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->
                        <span class="hidden-xs">{{ Auth::guard('staff_admin')->user()->username }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ Auth::guard('staff_admin')->user()->username }} - Web Developer
