...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('lai.layout.main-header')

    {{--main-sidebar--}}
    @include('lai.layout.main-sidebar')

    {{--main-content--}}
    @include('lai.layout.main-content')

    {{--main-footer--}}
{{--    @include('lai.layout.main-footer')--}}

    {{--control-sidebar--}}
    @include('lai.layout.control-sidebar')
