            ...
            <div class="col-md-4 col-md-offset-4 probootstrap-animate-">
                <p class="text-center">
                    ...
                    <video width="720" height="416" controls="" id="myVideo" style="display:none;">
                        <source src="http://cdn.keron-relo.com/videos/KERON_ZH.mp4" type="video/mp4">
                    </video>
