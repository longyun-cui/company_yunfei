        ...
        <div class="module-row module-body-container">
            <div class="item-col col-md-3 col-sm-6 col-xs-6">
                <div class="feature clearfix">
                    ...
                    <h6 class="entry-title title-sm">CCTV1 上榜品牌</h6>
                    {{--<p>深耕细作上海及周边市场10余年。真正一线品牌，保证钢琴品质。 </p>--}}
                    <p>有我们在，城市生活更舒心。从2008年开展钢琴出租业务以来不惜成本，一贯采用高品质钢琴服务广大琴童，深受音乐学院教师好评。 </p>
                </div>
            </div>
            <div class="item-col col-md-3 col-sm-6 col-xs-6">
                <div class="feature clearfix">
                    ...
                    <p>顶级型号免押金月租256元，使用期间免费不限次维修调音。音色纯正，品质保证，价格更动人，用琴更放心。 </p>
                </div>
            </div>
            <div class="item-col col-md-3 col-sm-6 col-xs-6">
                <div class="feature clearfix">
            ...
            <div class="item-col col-md-3 col-sm-6 col-xs-6">
                <div class="feature clearfix">
                    ...
                    <h6 class="entry-title title-sm">眼光好</h6>
                    {{--<p>知名钢琴老师免费提供钢琴教学。</p>--}}
                    <p>当您需要换一架不同风格的钢琴，眼光独到的您一定不会错过我们。</p>
                </div>
            </div>
        </div>
