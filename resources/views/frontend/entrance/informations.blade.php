...
{{--html.head--}}
@section('head_title')最新资讯-汉盟房产@endsection
...
@section('custom-content')
    ...
    <section id="home-property-listing" class="">
        <header class="section-header home-section-header text-center">
            <div class="container">
                <h2 class="wow slideInRight">最新资讯</h2>
                <p class="wow slideInLeft font-24px"><b>随时了解最新资讯，掌握市场动态</b></p>
            </div>
        </header>
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 layout-item-wrap">
                        <article class="property layout-item clearfix">
                            <figure class="feature-image">
                                <a class="clearfix zoom-" target="_blank"  href="{{ url('/information/'.$v->id) }}">
                                    <img data-action="zoom-" src="{{ config('common.host.'.env('APP_ENV').'.cdn').'/'.$v->cover_pic }}" alt="Property Image">
                                </a>
                                <span class="btn btn-warning btn-sale ">最新</span>
                            </figure>
                            <div class="property-contents clearfix">
                                <header class="property-header clearfix">
                                    <div class="pull-left">
                                        <h6 class="entry-title"><a href="{{ url('/house/'.$v->id) }}">{{ $v->title or '' }}</a></h6>
                                        <span class="property-location _none"><i class="fa fa-map-marker"></i> {{ $v->custom->position or '' }} </span>
                                    </div>
                                    <a target="_blank" href="{{ url('/information/'.$v->id) }}">
