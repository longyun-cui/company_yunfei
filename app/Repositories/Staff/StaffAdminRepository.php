...
//        $this->model = new User;
    ...
    public function view_info_index()
    {
        ...
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.info.index')->with(['data'=>$me]);
    }
    // 【基本信息】返回-编辑-视图
    public function view_info_edit()
    {
        $me = Auth::guard('admin')->user();
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.info.edit')->with(['data'=>$me]);
    }
    // 【基本信息】保存数据
...
//            exit($e->getMessage());
    ...
    {
        $me = Auth::guard('admin')->user();
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.info.password-reset')->with(['data'=>$me]);
    }
    // 【密码】保存数据
...
//        if(!is_numeric($type)) return view(env('TEMPLATE_STAFF_ADMIN').'errors.404');
//        if(!in_array($type,[1,2,3,10,11,88])) return view(env('TEMPLATE_STAFF_ADMIN').'errors.404');
    ...
    public function view_user_user_create()
    {
        ...
        $view_blade = env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-edit';
    ...
    public function view_user_user_edit()
    {
        ...
        else
        {
            ...
            if($mine)
            {
                if(!in_array($mine->user_category,[1,9,11,88])) return view(env('TEMPLATE_STAFF_ADMIN').'errors.404');
            ...
            else return view(env('TEMPLATE_STAFF_ADMIN').'errors.404');
        }
    }
    // 【用户】【组织】保存数据
...
//            exit($e->getMessage());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-list-for-all')
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-list-for-individual')
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-list-for-doc')
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-list-for-org')
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.user.user-list-for-sponsor')
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.item.item-list-for-all')
            ->with([
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.item.item-list-for-atom')
            ->with([
                'sidebar_item_list_active'=>'active',
...
//        dd($list->toArray());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.item.item-list-for-doc')
            ->with([
                'sidebar_item_list_active'=>'active',
...
//        dd($list->toArray());
    ...
    public function view_district_create()
    {
        ...
        $view_blade = env('TEMPLATE_STAFF_ADMIN').'entrance.district.district-edit';
        return view($view_blade)->with([
            'operate'=>'create',
            'operate_id'=>0,
            'category'=>'item',
    ...
    public function view_district_edit()
    {
        ...
        else
        {
            ...
            {
//                if(!is_numeric($type)) return view(env('TEMPLATE_STAFF_ADMIN').'errors.404');
                if(!in_array($mine->district_type,[1,2,3,4,11,21,31,41])) return view(env('TEMPLATE_STAFF_ADMIN').'errors.404');
                $mine->custom = json_decode($mine->custom);
                $mine->custom2 = json_decode($mine->custom2);
                $mine->custom3 = json_decode($mine->custom3);
...
//            exit($e->getMessage());
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.district.district-list-for-all')
            ->with([
...
//            else $shared_root_scale[$k]->name = "其他";
        ...
        $view_blade = env('TEMPLATE_STAFF_ADMIN').'entrance.statistic.statistic-index';
    ...
    public function view_statistic_user($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_STAFF_ADMIN').'entrance.statistic.statistic-user';
        return view($view_blade)->with($view_data);
    }
    // 【】流量统计
    public function view_statistic_item($post_data)
    {
        ...
        $view_blade = env('TEMPLATE_STAFF_ADMIN').'entrance.statistic.statistic-item';
        return view($view_blade)->with($view_data);
    }
    ...
    {
        return view(env('TEMPLATE_STAFF_ADMIN').'entrance.statistic.statistic-all-list')
            ->with([
