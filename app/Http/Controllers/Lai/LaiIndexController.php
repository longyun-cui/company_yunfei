<?php
namespace App\Http\Controllers\Lai;
...
use App\Repositories\Lai\LaiIndexRepository;

use Response, Auth, Validator, DB, Exception;
use QrCode, Excel;

class LaiIndexController extends Controller
{
    //
    private $service;
    private $repo;
    ...
    {
        $this->repo = new LaiIndexRepository;
    }
